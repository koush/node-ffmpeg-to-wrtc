...
export class FFMpegRTCSession {
    ...
    constructor(url: string, send: (json: any) => void) {
        this.url = url;
        this.send = send;
    ...
    async _start() {
        ...
        this.pc.addTrack(videoSource.createTrack());
        const audioSource = new RTCAudioSource();
        this.pc.addTrack(audioSource.createTrack());
...
async function createFFMpegRTCSession(url: string) {
